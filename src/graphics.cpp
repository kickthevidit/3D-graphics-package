...
//       radius *= -1;
//   }
//   Sphere(const Vec3 &c, double r, Pixel &p, double d, Vec3 al) : Shape(p, d, al), center(c), radius(r) {
//     if (radius < 0)
//       radius *= -1;
//   }
...
//       radius *= -1;
//   }
//   Sphere(const Vec3 &c, double r, Material &m) : Shape(m), center(c), radius(r) {
//     if (radius < 0)
//       radius *= -1;
//   }
...
// public:
//   Line(Vec3 o, Vec3 d, Material m) : Shape(m), pos(o), dir_(d) {}
...
//   sample_img = Render::CreateCanvas(width, height, bg_col, orig, objects, lights);
